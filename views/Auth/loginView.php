...
<body>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php Helper::route('/auth/login') ?>" class="needs-validation" novalidate="">
  ...
  <!-- General JS Scripts -->
  <script src="http://localhost:8080/src/js/app.min.js"></script>
  <!-- JS Libraies -->
  <!-- Page Specific JS File -->
  <!-- Template JS File -->
  <script src="http://localhost:8080/src/js/scripts.js"></script>
  <!-- Custom JS File -->
  <script src="http://localhost:8080/src/js/custom.js"></script>
</body>
