      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php Helper::route("/dashboard/{$SESSION['user']}") ?>"> <img alt="image" src="<?php Helper::route('/image/logo.png') ?>" class="header-logo" /> <span
                class="logo-name">Smart Trips</span>
            </a>
          </div>
